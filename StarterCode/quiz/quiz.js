...
function displayResult(){
  ...
  }else if (productivityPoints >= 5 || productivityPoints <= 8) {
    result = "You're Struggling";
  }else if (productivityPoints >= 9 || productivityPoints <= 12) {
    result = "Productive Pro";
  }else if (productivityPoints >= 13) {
